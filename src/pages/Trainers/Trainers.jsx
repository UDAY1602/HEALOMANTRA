      ...
      <div className="trainer-row">
        ...
        <div className="trainer-content">
          ...
          <p className="desc">
            ...
            His expertise spans traditional yoga systems, therapeutic applications, and modern wellness integrations. Vamshi has also spearheaded collaborations with major wellness and fitness brands such as Decathlon, Praan Health Mental Wellness, and Amro Café. A national-level yoga champion, he brings deep technical knowledge, leadership, and a holistic approach to physical and mental well-being.
          </p>
        </div>
      ...
      <div className="trainer-row">
        ...
        <div className="trainer-content">
          ...
          <p className="desc">
            ...
            She is skilled in creating inclusive, safe, and engaging classes suitable for all levels, with a strong focus on alignment, breathwork, and mindful movement. Sarita is also experienced in class design, injury modification, and personalized guidance, contributing significantly to student retention and community building within the studio.
          </p>
        </div>
      ...
      <div className="trainer-row">
        ...
        <div className="trainer-content">
          ...
          <p className="desc">
            ...
            Her teaching approach emphasizes breathwork, pranayama, guided meditation, and holistic lifestyle practices. Alekya has worked with diverse age groups through studio classes, private home sessions, and wellness programs, supporting physical health, mental calmness, and personal growth. She also has additional training in acupressure and acupuncture principles.
          </p>
        </div>
      ...
      <div className="trainer-row">
        ...
        <div className="trainer-content">
          ...
          <p className="desc">
            ...
            Her skill set includes therapeutic yoga, acupressure therapy, ayurvedic and yogic diet consultation, and traditional Hatha and Ashtanga yoga practices. Manashi brings a disciplined, therapeutic, and education-focused approach to yoga, making her well-suited for structured programs, group classes, and wellness education
          </p>
        </div>
